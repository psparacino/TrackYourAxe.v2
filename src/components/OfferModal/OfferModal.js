      ...
      <Modal
        ...
        <>
          ...
          <Modal.Body style={{textAlign: 'center'}}>
            {newOfferAmount > 0 ?
            <h4>You are offering {ethers.constants.EtherSymbol}{newOfferAmount} for this provenance</h4>
              : null}
            <input 
              name="userAddress" 
              type="text" 
            ...
            <div>
              <Button variant='warning' style={{fontSize: '20px'}} onClick={offer}>send offer</Button>
            </div>       
          </Modal.Body>
        </>
