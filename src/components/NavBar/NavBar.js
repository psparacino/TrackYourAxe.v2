...
const NavBar = () => {
  ...
  return (
    <Navbar
      ...
      variant="light"
      bg="light"
      style={{ padding: "5px 10px", alignItems: "space-between" }}
    >
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className={styles.NavEdits}>
          ...
          <Nav.Link href="/provenances">
            {truncateAddress(mainAccount)} Items
          </Nav.Link>
          {/* 
          ...
          <NavDropdown
            title="Transfers"
            style={quantity > 0 ? { color: "red" } : null}
            id={quantity > 0 ? "incoming" : "nav-dropdown"}
          >
            <NavDropdown.Item
              href="/incoming-transfers"
              style={quantity > 0 ? { color: "red" } : null}
              eventKey="4.1"
            >
              Claim Incoming Transfers {quantity > 0 ? `(${quantity})` : null}
            </NavDropdown.Item>
            <NavDropdown.Item href="/offers" eventKey="4.2">
              Offers on Provenances
            </NavDropdown.Item>
          </NavDropdown>
          ...
          <NavDropdown title="Guides" id="nav-dropdown">
            <NavDropdown.Item href="/guides/wallet" eventKey="4.1">
              Wallet Info
            </NavDropdown.Item>
            <NavDropdown.Item href="/guides/tutorial" eventKey="4.2">
              Tutorial
            </NavDropdown.Item>
            <NavDropdown.Item href="/guides/how-it-works" eventKey="4.2">
              How Does TYA Work?
            </NavDropdown.Item>
            <NavDropdown.Divider />
