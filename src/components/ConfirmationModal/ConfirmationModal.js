...
export function ConfirmationModal(props) {
  ...
  const verificationPhotoURL =
    ipfsGetterRootURL + props.formdata.verificationphotohash;
  ...
  const ItemImageCarousel = () => {
    return (
      <div>
        {props.formdata.instrumentphotohashes &&
        props.formdata.instrumentphotohashes.length > 0 ? (
