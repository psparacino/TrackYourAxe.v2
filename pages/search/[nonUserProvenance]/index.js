...
const NonUserProvenance = () => {
  ...
  const ProvenanceHistory = () => { 
    ...
    if (loaded) {
      console.log(loaded, "loaded in if")
    ...
    return (
      <Container>
      {console.log(provenanceContract, "contract in return")}
