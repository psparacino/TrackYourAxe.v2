      ...
      return (
        <>
          <h4 style={{ textAlign: "center" }}>
            ...
            <Link href="/provenances">items</Link> page to transfer provenances
            or <Link href="/guides/tutorial">here</Link> to learn how.
          </h4>
          <nav>
            {pendingTransferContracts.map((array, index) => {
              ...
              const { ownerAddress, name, verificationPhotoHash } =
                ProvenanceOwnerInfo;
                          ...
                          <Card.Body>
                            <Row>
                              <Col>
                                <img
                                  key={
                                    provenanceAddress + verificationPhotoHash
                                  }
                                  src={
                                    ipfsGetterRootURL + verificationPhotoHash
                                  }
                                  style={{
                                    objectFit: "contain",
                                    width: "100%",
