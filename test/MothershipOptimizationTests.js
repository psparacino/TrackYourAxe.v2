...
const ProvenanceABI = require('../artifacts/contracts/ProvenanceOptimization.sol/ProvenanceOptimization.json');


//const provider = new ethers.providers.Web3Provider(window.ethereum);
//const signer = provider.getSigner(0);

describe("Mothership-Transfer Optimization Tests", function () {
    ...
    beforeEach(async function () {
        ...
        MSC = await ethers.getContractFactory('MothershipOptimization');
