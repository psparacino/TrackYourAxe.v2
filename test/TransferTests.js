...
describe("Provenance Tests", function () {
    ...
    it("Provenance Pending Owner is added before transfer and removed after", async function() {
        ...
        // console.log(await ProvenanceContractTest.ownerProvenance(2), "owner2 in Provenance");
        console.log(await ProvenanceContractTest.getOwnershipHistory(), "function test");
